...
export function Header({ neynarUser }: HeaderProps) {
  ...
  return (
    <div className="relative">
      <div className="mt-4 mb-4 mx-4 px-4 py-4 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-between">
        <div className="text-lg font-light">🎁 &nbsp;{APP_NAME}!</div>
        {context?.user && (
          <div
