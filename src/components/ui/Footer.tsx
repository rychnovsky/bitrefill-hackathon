...
export const Footer: React.FC<FooterProps> = ({
  ...
  <div className="fixed bottom-0 left-0 right-0 mx-4 mb-4 bg-gray-100 dark:bg-gray-800 border-[1px] border-single border-primary px-2 py-2 rounded-lg z-50">
    <div className="flex justify-around items-center h-14">
      ...
      <button
        onClick={() => setActiveTab(Tab.HowItWorks)}
        className={`flex flex-col items-center justify-center w-full h-full ${
          activeTab === Tab.HowItWorks
            ? "text-primary dark:text-primary-light"
            : "text-gray-500 dark:text-gray-400"
        }`}
      >
